...
class MyService {
	 ...
	 */
	@HystrixCommand(groupKey = "getAppleGroup", threadPoolKey = "getAppleCommand")
	 ...
	 */
	@HystrixCommand(groupKey = "getOrangeGroup", threadPoolKey = "getOrangeCommand", fallbackMethod = "fallbackOrange")
